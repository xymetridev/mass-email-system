...
<div class="page-header d-print-none mb-4">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title">Buat Template Master</h2>
        </div>
        <div class="col-auto ms-auto">
            <a href="<?= url_to('admin.templates') ?>" class="btn btn-outline-secondary">Batal</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg">
            <div class="modal-header">
                <h5 class="modal-title">Simpan ke Pustaka Master</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label required">Nama Template</label>
                    <input type="text" id="template_name" class="form-control" placeholder="Contoh: Promo Akhir Tahun v1">
                    <small class="text-muted">Gunakan nama yang mudah dikenali tim Anda.</small>
                </div>
            </div>
...
<script>
    ...
    function saveTemplate() {
        ...
        fetch('<?= url_to('admin.templates.store') ?>', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(res => {
            if(res.status === 'success') {
                ...
                setTimeout(() => {
                    window.location.href = '<?= url_to('admin.templates') ?>';
                }, 1500);
            } else {
