...
<div class="page-header d-print-none mb-4">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title">Edit Template Master</h2>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg">
            <div class="modal-header">
                <h5 class="modal-title">Perbarui Template</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label required">Nama Template</label>
                    <input type="text" id="template_name" class="form-control" value="<?= esc($template->name) ?>" placeholder="Contoh: Promo Akhir Tahun v1">
                </div>
            </div>
...
<script>
    ...
    function updateTemplate() {
        ...
        fetch('<?= url_to('admin.templates.update', $template->id) ?>', {
            method: 'POST',
            body: formData,
            headers: {
